Here's an example of a simple web server program that runs on an ESP8266 and controls a 4-channel relay module. This program uses the ESP8266's built-in WiFi capabilities and the Arduino IDE.
